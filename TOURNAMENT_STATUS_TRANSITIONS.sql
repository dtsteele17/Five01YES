-- =======================================================
-- TOURNAMENT STATUS TRANSITIONS - DARTCOUNTER.NET STYLE
-- =======================================================
...
BEGIN
  ...
  LOOP
    ...
    IF v_participant_count >= 2 THEN
      ...
      -- Try to generate bracket (if function exists)
      BEGIN
        PERFORM generate_tournament_bracket(v_tournament.id);
      EXCEPTION WHEN undefined_function THEN
        -- Bracket generation function doesn't exist, continue
        NULL;
      EXCEPTION WHEN OTHERS THEN
        -- Log error but don't fail the status transition
        RAISE NOTICE 'Error generating bracket for tournament %: %', v_tournament.id, SQLERRM;
      END;
    ...
    ELSE
      ...
      SET status = 'cancelled',
          cancelled_reason = 'Insufficient participants (minimum 2 required)',
          cancelled_at = NOW()
      WHERE id = v_tournament.id;
