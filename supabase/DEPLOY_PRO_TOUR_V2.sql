...
DECLARE
  ...
  v_first_names TEXT[] := ARRAY[
    ...
    'Adrian','Nathan','Joe','Dave','Rob','Luke','Brendan','Danny','Gabriel','Ross',
    'Stephen','Martin','Raymond','Simon','Andrew','Ryan','Jonny','Devon','Ricardo','Jose',
    'Florian','Keegan','Boris','Ted','John','Mark','Alan','Scott','Ian','Jamie',
    'Wayne','Colin','Terry','Andy','Steve','Dean','Kevin','Barry','Darren','Nigel',
    'Paul','Stuart','Vincent','Max','Jeff','Liam','Connor','Jake','Tyler','Ben',
    'Tom','Will','Sam','Alex','Oscar','Leo','Alfie','George','Charlie','Noah',
    'Arthur','Logan','Finley','Archie','Theo','Mason','Jack','Ricky','Graham','Stan',
    'Noel','Glen','Clive','Vince','Trevor','Roy','Wesley','Jelle','Maik','Niels',
    'Lars','Sven','Bjorn','Karel','Pieter','Joost','Rik','Derk','Jurgen','Stefan',
    'Dieter','Rainer','Helmut','Klaus','Wolfgang','Heinrich','Manfred','Fritz','Tomas','Krzysztof',
    'Piotr','Radek','Jiri','Mikkel','Rasmus','Kasper','Ruben','Sergio','Pablo','Antonio',
    'Diego','Rafael','Marco','Fabio','Luca','Alessandro','Roberto','Yuki','Kenji','Haruto',
    'Arjun','Vikram','Hamza','Omar','Ibrahim','Reece','Callum','Declan','Ronan','Cillian',
    'Paddy','Rhys','Owen','Toby','Freddie','Harvey','Zach','Brandon','Kian','Roman',
    'Joel','Micah','Jasper','Felix','Hugo','Rocco','Enzo','Daryl','Dirk','Mervyn',
    'Ritchie','Craig','Shaun','Neil','Glen','Karl','Ollie','Marcus','Heath','Perry'
  ];
  v_surnames TEXT[] := ARRAY[
    'Steele','Wells','Hall','Maier','Holmes','Baker','Hutchinson','Perry','Davies',
    'Anderson','Wright','Price','Smith','Lewis','Brown','King','Wilson','Adams','Mitchell',
    'Warren','Ashton','Nicholson','Hamilton','Webster','Hughes','Owen','Green','Cooper','Evans',
    'Harris','Clark','Robinson','Turner','Wood','Walker','Allen','Young','Phillips',
    ...
    'Bos','Hendriks','Scholten','Vos','Kuijpers','Peters','Willems','Brouwer','van Hoorn','Bloemen',
    ...
    'Patel','Sharma','Singh','Kumar','Khan','Tanaka','Sato','Chen','Wang',
    'Connolly','Murphy','Gallagher','Doyle','Brennan','Quinn','Reilly','Byrne','Daly',
    'Spencer','Rhodes','Pearce','Knight','Griffin','Cole','Chambers','Marsh','Barker','Holt',
    'Lowe','Taylor','Jenkins','Hempel','Petersen','Rodriguez','Clemens','Watts','Grant','Boyd',
    'Payne','Moss','Lambert','Norris','Sutton','Chapman','Dixon','Gibbs','Stokes','Frost',
    'Blake','Maddox','Rowley','Carver','Pratt','Woodward','Langley','Buckley','Saunders','Hargreaves'
  ];
  v_nicknames TEXT[] := ARRAY[
    ...
    'Skill Magill','The Tornado','Dynamite','The Ace','Goldfinger','The General','Rambo','The Hitman',
    'Demolition Man','The Artist','Kung Fu','The Prince','Old Stoneface','The Flying Scotsman',
    'The Wizard','Titanium','The Sheriff','Bully Boy','The Apache','The Dark Destroyer',
    'The Bronzed Adonis','Superchin','The Huntsman','The Ferret','Dazzler','The Pirate',
    'Mr Freeze','The Gladiator','The Joker','Boom Boom','The Tank','Spider','The Spartan',
    'Matchstick','The Predator','Chopper','Iron Mike','The Milkman','The Undertaker','Showtime',
