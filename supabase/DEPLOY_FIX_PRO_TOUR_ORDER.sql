UPDATE career_schedule_templates SET sequence_no = 8 WHERE tier = 5 AND event_subtype = 'pro_major_england';
UPDATE career_schedule_templates SET sequence_no = 9 WHERE tier = 5 AND event_subtype = 'ws_usa';
