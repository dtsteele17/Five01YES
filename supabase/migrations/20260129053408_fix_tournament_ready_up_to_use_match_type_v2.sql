/*
  # Fix Tournament Ready Up to Use match_type v2

  ## Overview
  Update ready_up_tournament_match() to explicitly set match_type='tournament'
  when creating match rooms for tournament matches.

  ## Changes Made
  - Drop and recreate ready_up_tournament_match() with match_type and source
*/
