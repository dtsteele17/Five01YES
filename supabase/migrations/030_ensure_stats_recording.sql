-- Ensure match_history has all needed columns and indexes for filtering
...
-- Ensure fn_update_player_match_stats properly records match_format and game_mode
...
BEGIN
  ...
  -- Update player_stats (overall cumulative stats)
  ...
  -- Update quick match specific stats
...
COMMENT ON FUNCTION public.fn_update_player_match_stats IS 'Updates player stats and records match history with match_format';
