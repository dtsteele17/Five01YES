...
-- FIXED VERSION - handles existing constraint violations
...
-- Fix existing match_signals rows that might violate the new constraint
-- First, let's see what types exist and update any invalid ones
