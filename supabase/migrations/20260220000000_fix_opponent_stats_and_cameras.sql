-- ============================================================================
-- FIX: Opponent Stats Recording + Camera Support
-- ============================================================================
...
-- This version correctly calculates stats from ALL visits (including checkouts)
-- ============================================================================
...
-- ============================================================================
SELECT 
  'Opponent stats fix applied!' as status,
  (SELECT COUNT(*) FROM information_schema.columns 
   WHERE table_name = 'match_history' 
   AND column_name LIKE 'opponent_%') as opponent_columns_count;
