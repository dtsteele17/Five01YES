-- ============================================
-- FIX: 301/501 Camera and Checkout Issues
-- ============================================

-- ============================================
-- PART 1: Fix match_signals table for 301/501
-- ============================================

-- Drop any existing policies that might reference old columns
DO $$
DECLARE
  pol RECORD;
BEGIN
...
-- Recreate match_signals with EXACT schema for 301/501
...
CREATE POLICY "match_signals_delete"
...
-- ============================================
-- PART 2: Drop and recreate RPC function
-- ============================================
...
-- ============================================
-- PART 3: Fix checkout constraint
-- ============================================
...
-- DONE
-- ============================================
SELECT '301/501 camera and checkout fix applied!' as status;
