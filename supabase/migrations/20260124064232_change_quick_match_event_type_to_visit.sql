/*
  # Change Quick Match event type to 'visit'

  1. Changes
    - Update `submit_quick_match_throw` to insert 'visit' event type instead of 'throw'
    - This aligns with private match event types for consistency
    - Makes adapter compatible with both quick match and private match formats

  2. Notes
    - Event payload remains the same
    - Only the event_type field changes
*/
