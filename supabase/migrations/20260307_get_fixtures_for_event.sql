-- ============================================================
-- New RPC: Get fixtures for a SPECIFIC event (used for results view)
-- Called when returning from a match to show that matchday's results
-- ============================================================
...
BEGIN
  ...
  -- Get player's match for this event
  ...
  -- Get other opponents for simulated fixtures
  SELECT ARRAY(
