/*
  # Fix Ranked Match Game Mode

  1. Changes
    - Update `rpc_ranked_enqueue()` to use game_mode = 2 (ranked) instead of 501
    - Game mode values:
      - 1 = Quick Match
      - 2 = Ranked Match
      - 3 = Private Match
  ...
  2. Notes
    - Ranked matches are best-of-5 (legs_to_win = 3)
    - Starting score remains 501
*/

-- Recreate the enqueue function with correct game_mode
...
BEGIN
  ...
  IF v_opponent_id IS NOT NULL THEN
    -- Create match room with game_mode = 2 for ranked
