/*
  # Update Quick Match to use 'throw' event type

  1. Changes
    - Update `submit_quick_match_throw` to insert 'throw' event type instead of 'visit'
    - This ensures consistency with Local match which uses 'throw' events
    - Makes adapter filtering simpler (only need to check for 'throw')

  2. No breaking changes
    - Existing events remain as-is
    - Only new events will use 'throw' type
*/
