-- ============================================================================
-- FIX ATC SIGNALING - BROADCAST TO ALL PLAYERS
-- ============================================================================

-- 1. Drop and recreate atc_match_signals with simplified schema
-- ============================================================================
...
-- RLS Policies - allow all players to see all signals in their match
...
CREATE POLICY "ATC signals viewable"
  ...
  USING (true); -- Allow viewing all (filtered by match_id in app)
