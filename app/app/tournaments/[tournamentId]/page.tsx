        ...
        try {
          ...
          if (result?.action === 'tournament_live') {
            ...
            if (!tCheck?.bracket_generated_at) {
              console.log('Bracket not generated by progression RPC, calling generate_tournament_bracket directly');
              await supabase.rpc('generate_tournament_bracket', { p_tournament_id: tournamentId });
              await supabase.rpc('start_tournament_round_one', { p_tournament_id: tournamentId });
            }
