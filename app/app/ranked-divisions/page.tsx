        ...
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-5">
            <div className="relative">
              <div className={`absolute inset-0 ${colors.bg}/40 rounded-2xl blur-xl animate-pulse`} />
              <div className={`absolute inset-0 ${colors.bg}/60 rounded-2xl blur-lg`} />
              <div className={`relative w-20 h-20 rounded-2xl bg-gradient-to-br ${colors.gradient} flex items-center justify-center shadow-2xl ${colors.glow} ring-2 ring-white/20`}>
            ...
            <div>
              ...
              <div className="relative">
                <h2 className="text-3xl font-black text-white mt-1 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">
                  {playerState.division_name}
                </h2>
                <div className={`absolute -inset-2 ${colors.bg}/20 rounded-lg blur-md -z-10`} />
              </div>
            </div>
          </div>
    ...
    <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-r ${colors.gradient} p-6 mb-6 shadow-lg ${colors.glow}`}>
      ...
      <div className="relative flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className={`w-16 h-16 rounded-xl flex items-center justify-center ${isGrandChampion ? 'bg-white/30 backdrop-blur-sm' : 'bg-white/20 backdrop-blur-sm'}`}>
...
// Tier Navigator - All ranks including Grand Champion in progression
function TierNavigator({ 
  ...
  // Include all tiers (including Grand Champion) in progression
  const allTiers = tiers;
  const totalPages = Math.ceil(allTiers.length / ranksPerPage);
  ...
  const currentTiers = allTiers.slice(
  ...
  return (
    <div className="space-y-6">
      {/* Tier Navigator - All Ranks Including Grand Champion */}
