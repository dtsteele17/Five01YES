...
const CHECKOUT_ROUTES: Record<number, string[]> = {
  ...
  102: ['T20', 'T10', 'D11'],
  101: ['T20', 'T17', 'D4'],
  100: ['T20', 'D20'],           // 60 + 40 = 100 ✓ (pro 2-dart)
  99: ['T20', '19', 'D10'],      // 60 + 19 + 20 = 99 ✓
  98: ['T20', '18', 'D10'],      // 60 + 18 + 20 = 98 ✓
  97: ['T19', 'D20'],            // 57 + 40 = 97 ✓ (pro 2-dart)
  96: ['T20', 'D18'],            // 60 + 36 = 96 ✓ (pro 2-dart)
  95: ['T19', 'D19'],            // 57 + 38 = 95 ✓ (pro 2-dart)
  94: ['T18', 'D20'],            // 54 + 40 = 94 ✓ (pro 2-dart)
  93: ['T19', 'D18'],            // 57 + 36 = 93 ✓ (pro 2-dart)
  92: ['T20', 'D16'],            // 60 + 32 = 92 ✓ (pro 2-dart)
  91: ['T17', '14', 'D20'],      // 51 + 14 + 40 = 91 ✓
  90: ['T20', 'D15'],
  89: ['T19', 'T20', 'D1'],
  88: ['T20', 'T16', 'D2'],
  87: ['T20', 'T17', 'D2'],
...
const CHECKOUT_ROUTES_2_DARTS: Record<number, string[]> = {
  ...
  93: ['T19', 'D18'],
  92: ['T20', 'D16'],
  // Note: 91 cannot be done in 2 darts (91-60=31, not a double)
  90: ['T20', 'D15'],
  89: ['T19', 'D16'],
  88: ['T20', 'D14'],
  87: ['T17', 'D18'],
