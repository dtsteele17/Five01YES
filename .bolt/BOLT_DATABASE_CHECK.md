# Bolt Database Connection Check Page

## Overview

The Bolt Database Connection Check page is located at `/app/dev/bolt-database-check` and provides comprehensive testing of your Supabase connection in development, preview, and production environments.

## Accessing the Page

Navigate to: `https://your-domain.com/app/dev/bolt-database-check`

Or in development: `http://localhost:3000/app/dev/bolt-database-check`
...
### Development
Visit: `http://localhost:3000/app/dev/bolt-database-check`

### Preview/Staging
Visit: `https://preview-url.netlify.app/app/dev/bolt-database-check`

### Production
Visit: `https://your-domain.com/app/dev/bolt-database-check`
