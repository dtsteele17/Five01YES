      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="relative h-48">
            ...
            {/* Bars */}
            <div className="absolute left-10 right-0 top-0 bottom-6 flex items-end gap-[2px]">
              {chartData.map((d, i) => {
                const height = ((d.avg - chartMin) / valueRange) * 100;
                return (
                  <div
                    key={d.date}
                  ...
                  >
                    {/* Tooltip */}
                    <div className="hidden group-hover:block absolute bottom-full mb-2 bg-slate-900 border border-slate-600 rounded-lg px-3 py-2 text-xs z-10 whitespace-nowrap shadow-lg">
                    ...
                    <div
                      className="w-full rounded-t-sm bg-gradient-to-t from-purple-600 to-purple-400 hover:from-purple-500 hover:to-purple-300 transition-all min-h-[2px]"
