      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-slate-800">
            <th className="text-left py-3 px-4 text-xs font-semibold text-slate-400 uppercase">Pos</th>
            <th className="text-left py-3 px-4 text-xs font-semibold text-slate-400 uppercase">Player</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">P</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">W</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">L</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">Leg Diff</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">Pts</th>
            <th className="text-center py-3 px-4 text-xs font-semibold text-slate-400 uppercase">Form</th>
          </tr>
        </thead>
        <tbody>
          {league.standings.map((standing, index) => {
            ...
            return (
              ...
              >
                ...
                <td className="py-4 px-4 text-center text-white font-medium">{standing.played}</td>
                <td className="py-4 px-4 text-center text-green-400 font-medium">{standing.won}</td>
                <td className="py-4 px-4 text-center text-red-400 font-medium">{standing.lost}</td>
