...
export const TIER_THEMES: Record<number, TierTheme> = {
  ...
  5: {
    name: 'Pro Tour',
    pageBg: 'bg-gradient-to-br from-red-950/30 via-slate-900 to-slate-950',
    cardBg: 'bg-gradient-to-br from-red-900/15 via-slate-800/40 to-slate-900/80',
    ...
    textGradient: 'bg-gradient-to-r from-red-400 to-rose-400',
