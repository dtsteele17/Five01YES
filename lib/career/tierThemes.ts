...
const TIER_1: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-green-950 via-green-900/50 to-stone-950',
  pageOverlay: '',
...
const TIER_2: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-blue-950 via-blue-900/40 to-slate-950',
  pageOverlay: '',
...
const TIER_3: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-cyan-950 via-cyan-900/40 to-slate-950',
  pageOverlay: '',
...
const TIER_4: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-orange-950 via-orange-900/40 to-amber-950',
  pageOverlay: '',
...
const TIER_5_DEFAULT: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-red-950 via-red-900/30 to-rose-950',
  pageOverlay: '',
...
const TIER_5_CS: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-purple-950 via-purple-900/40 to-amber-950/30',
  pageOverlay: '',
...
const TIER_5_WS: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-indigo-950 via-indigo-900/35 to-sky-950',
  pageOverlay: '',
...
const TIER_5_OPEN: TierTheme = {
  ...
  pageBg: 'bg-gradient-to-br from-emerald-950 via-emerald-900/35 to-teal-950',
  pageOverlay: '',
