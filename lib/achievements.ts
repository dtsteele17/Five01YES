export interface Achievement {
  ...
  title: string;
  description: string;
  category: 'ranked' | 'league' | 'tournaments' | 'practice' | 'atc' | 'funny' | 'milestones' | 'scoring' | 'career';
  icon: string;
  completed: boolean;
  progress: number;
  goal: number;
...
export const achievements: Achievement[] = [
  ...
  },
  {
    id: 'promotion-party',
    title: 'Promotion Party',
    description: 'Get promoted in career mode',
    category: 'career',
    icon: 'trending-up',
    completed: false,
    progress: 0,
  ...
  },
  {
    ...
    description: 'Reach Tier 3 (County Circuit)',
    category: 'career',
    icon: 'shield',
    completed: false,
    progress: 0,
  ...
  },
  {
    id: 'career-legend',
    title: 'Career Legend',
    description: 'Reach Tier 5 (World Tour)',
    category: 'career',
    icon: 'crown',
    completed: false,
    progress: 0,
